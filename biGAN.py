...
save_img_dir = "./biGAN/{}_gan_imgs".format(dataset_name)
...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        torch.save({'state_dict':G.state_dict()}, os.path.join(save_model_dir, "cifar_G_full.tar"))
        torch.save({'state_dict':DG.state_dict()}, os.path.join(save_model_dir, "cifar_D_full.tar"))
